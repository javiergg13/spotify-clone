...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/icons/Time.astro", void 0);
...
const $$MusicsTable = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<table class="table-auto text-left min-w-full divide-y divide-gray-500/20"> <thead class=""> <tr class="text-zinc-400 text-sm"> <th class="px-4 py-2 font-light">#</th> <th class="px-4 py-2 font-light">Título</th> <th class="px-4 py-2 font-light">Álbum</th> <th class="px-4 py-2 font-light">${renderComponent($$result, "Time", $$Time, {})}</th> </tr> </thead> <tbody> <tr class="h-[16px]"></tr> ${songs.map((song, index) => renderTemplate`<tr class="border-spacing-0 text-gray-300 text-sm font-light hover:bg-white/10 overflow-hidden transition duration-400"> <td class="px-4 py-2 rounded-tl-lg rounded-bl-lg w-5">${index + 1}</td> <td class="px-4 py-2 flex gap-3"> <picture class=""> <img${addAttribute(song.image, "src")}${addAttribute(song.title, "alt")} class="w-11 h-11"> </picture> <div class="flex flex-col"> <h3 class="text-white text-base font-normal">${song.title}</h3> <span>${song.artists.join(", ")}</span> </div> </td> <td class="px-4 py-2">${song.album}</td> <td class="px-4 py-2 rounded-tr-lg rounded-br-lg">${song.duration}</td> </tr>`)} </tbody> </table>`;
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/components/MusicsTable.astro", void 0);
...
const Volume1 = () => /* @__PURE__ */ jsxs("svg", { fill: "currentColor", role: "presentation", height: "16", width: "16", "aria-hidden": "true", "aria-label": "Volumen alto", id: "volume-icon", viewBox: "0 0 16 16", children: [
...
const Volume2 = () => /* @__PURE__ */ jsx("svg", { fill: "currentColor", role: "presentation", height: "16", width: "16", "aria-hidden": "true", "aria-label": "Volumen alto", id: "volume-icon", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsx("path", { d: "M9.741.85a.75.75 0 0 1 .375.65v13a.75.75 0 0 1-1.125.65l-6.925-4a3.642 3.642 0 0 1-1.33-4.967 3.639 3.639 0 0 1 1.33-1.332l6.925-4a.75.75 0 0 1 .75 0zm-6.924 5.3a2.139 2.139 0 0 0 0 3.7l5.8 3.35V2.8l-5.8 3.35zm8.683 4.29V5.56a2.75 2.75 0 0 1 0 4.88z" }) });
const Volume3 = () => /* @__PURE__ */ jsx("svg", { fill: "currentColor", role: "presentation", height: "16", width: "16", "aria-hidden": "true", "aria-label": "Volumen alto", id: "volume-icon", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsx("path", { d: "M9.741.85a.75.75 0 0 1 .375.65v13a.75.75 0 0 1-1.125.65l-6.925-4a3.642 3.642 0 0 1-1.33-4.967 3.639 3.639 0 0 1 1.33-1.332l6.925-4a.75.75 0 0 1 .75 0zm-6.924 5.3a2.139 2.139 0 0 0 0 3.7l5.8 3.35V2.8l-5.8 3.35zm8.683 4.29V5.56a2.75" }) });
...
const VolumeControl = () => {
  ...
  const volumeLevel = () => {
    if (isVolumeSilenced)
      return /* @__PURE__ */ jsx(VolumeSilence, {});
    if (volume < 0.5 && volume > 0.1)
      return /* @__PURE__ */ jsx(Volume2, {});
    if (volume <= 0.1 && volume > 0)
      return /* @__PURE__ */ jsx(Volume3, {});
    return /* @__PURE__ */ jsx(Volume1, {});
  };
  return /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-x-2 text-white", children: [
    /* @__PURE__ */ jsx("button", { className: "opacity-70 hover:opacity-100 transition", onClick: handleClickVolumen, children: volumeLevel() }),
    /* @__PURE__ */ jsx(
      Slider,
      {
        defaultValue: [100],
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/icons/Library.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/icons/Home.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/icons/Search.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/components/SideMenuItem.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/components/SideMenuCard.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/layouts/Layout.astro", "self");
...
}, "C:/Users/N/visualStudioProjects/spotify-clone/src/pages/playlist/[id].astro", "self");

const $$file = "C:/Users/N/visualStudioProjects/spotify-clone/src/pages/playlist/[id].astro";
