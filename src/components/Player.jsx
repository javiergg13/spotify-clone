...
export const Volume3 = () => (
  <svg fill="currentColor" role="presentation" height="16" width="16" aria-hidden="true" aria-label="Volumen alto" id="volume-icon" viewBox="0 0 16 16"><path d="M9.741.85a.75.75 0 0 1 .375.65v13a.75.75 0 0 1-1.125.65l-6.925-4a3.642 3.642 0 0 1-1.33-4.967 3.639 3.639 0 0 1 1.33-1.332l6.925-4a.75.75 0 0 1 .75 0zm-6.924 5.3a2.139 2.139 0 0 0 0 3.7l5.8 3.35V2.8l-5.8 3.35zm8.683 4.29V5.56a2.75"></path></svg>
)
...
const VolumeControl = () => {
  ...
  const volumeLevel = () => {
    if (isVolumeSilenced) return <VolumeSilence />
    if (volume < 0.5 && volume > 0.1) return <Volume2 />
    if (volume <= 0.1 && volume > 0) return <Volume3 />
    return <Volume1 />
  }
...
export function Player() {
  ...
  const handleClick = () => {
    if (audioRef.current.src) setIsPlaying(!isPlaying)
  }
